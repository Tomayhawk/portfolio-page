    ...
    <div>
      ...
      {layout === 'grid' ? (
          ...
          <div className="w-full text-sm text-zinc-800 dark:text-zinc-200 pb-20 overflow-x-auto">
              <div className={`min-w-[1000px] ${styles.gridListHeader} py-3 border-b border-zinc-300 dark:border-zinc-700 font-semibold text-zinc-500 dark:text-zinc-400 select-none`}>
