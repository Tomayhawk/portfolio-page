  ...
  return (
    <div className="max-w-[1400px] mx-auto p-4 lg:p-8 animate-fadeIn">
      ...
      <div className="mb-6 lg:mb-8">
        ...
        <p className="text-zinc-600 dark:text-zinc-400 mt-1 text-sm lg:text-base">
      ...
      <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 items-start">
        {/* Left: The Board */}
        <div className="w-full lg:w-auto lg:flex-shrink-0 mx-auto lg:mx-0 max-w-[600px]">
        ...
        <div className="flex-1 w-full min-w-0 space-y-6">
             {/* Game Metadata Card */}
             <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-zinc-50 dark:bg-zinc-900 p-4 rounded-lg border border-zinc-200 dark:border-zinc-800 text-sm">
                 <div>
             ...
             {/* PGN Text Viewer */}
             <div className="bg-white dark:bg-zinc-950 rounded-lg border border-zinc-200 dark:border-zinc-800 shadow-sm overflow-hidden flex flex-col min-h-[300px] lg:h-[500px]">
                ...
                <div className="p-4 overflow-y-auto font-mono text-sm leading-relaxed text-zinc-700 dark:text-zinc-300 whitespace-pre-wrap flex-1">
                    {game.pgn}
                </div>
             </div>
        </div>
