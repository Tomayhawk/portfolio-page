      ...
      <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 items-start">
        ...
        <div className="w-full lg:w-auto lg:flex-shrink-0 mx-auto lg:mx-0 max-w-[600px] flex flex-col gap-4">
          ...
          <AnalysisBoard
            ...
            onEngineSettingsChange={(time, lines) => {
              setEngineTime(time);
        ...
        <div className="flex-1 w-full min-w-0 space-y-6">
          ...
          {/* Analysis Controls */}
          <div className="bg-zinc-50 dark:bg-zinc-900 p-4 rounded-lg border border-zinc-200 dark:border-zinc-800">
            <h3 className="text-lg font-semibold text-zinc-900 dark:text-zinc-100 mb-3">Analysis Controls</h3>
            <div className="space-y-4">
              <div className="flex justify-between items-center text-sm">
                <div className="flex gap-2 items-center">
                  <span>Engine Time: {engineTime}s</span>
                  <input
              ...
              <div className="flex justify-center gap-4 border-t border-zinc-200 dark:border-zinc-800 pt-2">
                ...
                <button
                  onClick={() => {
                    ...
                    // Reset would need to be handled differently since the board state is managed internally
                  }}
